...
// Si usas Redux importa el dispatch y la acción
// import { useDispatch } from 'react-redux';
// import { addItem } from '../redux/cartSlice';

function ProductList({ onHomeClick }) {
  const [showCart, setShowCart] = useState(false);
  const [showPlants, setShowPlants] = useState(true); // mostrar plantas por defecto
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: "Repels insects while adding a pleasant scent.",
          cost: 20
        },
        {
          name: "Basil",
